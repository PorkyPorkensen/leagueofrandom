...
export default function About(){
    return (
        <div className="siteDiv">
            ...
            <img className='siteLogo' src={logo} width={200} />
            <h1>About LOR</h1>
            <h3>LOR is a fan-made project, made by a  new Developer used for League of Legends enjoyoors
            ...
            <h2>Dont know who to play?? Head to the <a href='/random'>Elo Demolisher</a> to have a champ and build chosen for you.</h2>
            <h2>Know who to play but not what to build? Check out <a href='/cyc'>Choose Your Champ</a> and choose how spicy you want your build</h2>
